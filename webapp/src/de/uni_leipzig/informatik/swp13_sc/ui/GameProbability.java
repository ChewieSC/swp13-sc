...
public class GameProbability extends Table implements CellStyleGenerator
{
    ...
    public GameProbability(int tableWidth)
    {
        ...
        this.addContainerProperty("Draw", Double.class, null); // set 3
        // tablecolumns
        ...
        this.addItem(new Object[] { whiteProb, drawProb, blackProb },
                new Integer(1)); // make a row , which shows the probabilities
    ...
    public void showProb(double[] gameProb)
    {
        ...
        drawWidth = (int) (tableWidth * drawProb); // the column-width according
        // to the Probability and the
        // Width of the table
     ...
     * 
     * .v-table-cell-content-draw { background: gray; color: black; }
     * 
